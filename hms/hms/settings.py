...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-#q*^e-c)z^($c8kojbc%0)8wgdp@y^-fb++ou8_!e195o!ud&j')
...
GOOGLE_REDIRECT_URI = env('GOOGLE_REDIRECT_URI', default='http://localhost:8000/google/callback/')
